    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-header">
            ...
            <ul class="ht-nav">
                <li class="ht-nav-item">
                    <a target="_blank" href="<%=request.getContextPath()%>/index">前台入口</a>
                </li>
                <li class="ht-nav-item">
        ...
        <div class="layui-side">
            <div class="layui-side-scroll">
                <ul class="layui-nav layui-nav-tree" lay-filter="aaa">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="ArticleManage" data-id="1">文章管理</a></dd>
                            <dd><a href="javascript:;" data-url="ArticleEdtior" data-id="2">文章发布</a></dd>
                            <dd><a href="javascript:;" data-url="datalist.html" data-id="3">时光轴管理(未开发)</a></dd>
                            <dd><a href="javascript:;">笔记本管理</a></dd>
                            <dd><a href="javascript:;" data-url="datalist.html" data-id="4">文章回收站(未开发)</a></dd>
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="UserManage" data-id="8">全部用户</a></dd>
                            <dd><a href="javascript:;">黑名单管理(未开发)</a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:;"><i class="fa fa-wrench"></i>扩展管理</a>
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="LinkManage" data-id="9">友情链接</a></dd>
                            <dd><a href="javascript:;" data-url="BlogerManage" data-id="10">博主信息(未开发)</a></dd>
                            <dd><a href="javascript:;" data-url="BlogManage" data-id="11">网站信息(未开发)</a></dd>
                            <dd><a href="javascript:;" data-url="NoticeManage" data-id="5">网站公告</a></dd>
                            <dd><a href="javascript:;" data-url="datalist.html" data-id="6">更新日志(未开发)</a></dd>
                            <dd><a href="javascript:;" data-url="datalist.html" data-id="7">留言管理(未开发)</a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <p style="padding: 10px 15px; margin-bottom: 20px; margin-top: 10px; border:1px solid #ddd;display:inline-block;">
                            ...
                            <span style="padding-left:1em;">地点：广东珠海</span>
                            <span style="padding-left:1em;">时间：2019/5/29 15:20</span>
                        </p>
        ...
        <div class="layui-footer">
            <p style="line-height:44px;text-align:center;">BLOG后台管理系统 - Design By Ajar</p>
        </div>
        <!--快捷菜单-->
                ...
                <div class="layui-field-box">
                    <div style="width:832px;margin:0 auto;">
                        <div class="windows-tile windows-two">
                            ...
                            <span data-url="ArticleManage" data-id="1">文章管理</span>
                        </div>
                        <div class="windows-tile windows-one">
                            <i class="fa fa-volume-up"></i>
                            <span data-url="NoticeManage" data-id="2">网站公告</span>
                        </div>
                        <div class="windows-tile windows-one">
                        ...
                        <div class="windows-tile windows-two">
                            ...
                            <span data-url="LinkManage" data-id="4">友情链接</span>
                        </div>
                        <div class="windows-tile windows-one">
