...
<body>
            ...
            <div id="dataContent" class="">
                ...
                <table style="" class="layui-table" lay-even="">
                    ...
                    <c:forEach items="${pageInfo.list}" var="article">
                        <tr>
                            <td><fmt:formatDate value="${article.articleCreateTime}" pattern="yyyy年MM月dd日"/></td>
                            <td>${article.articleTitle}</td>
                            <td>${article.articleUserId}</td>
                            ...
                            <td>
                                <button class="layui-btn layui-btn-small layui-btn-normal" onclick="layui.datalist.editData(${article.articleId})"><i class="layui-icon">&#xe642;</i></button>
                            </td>
                            <td>
                                <button class="layui-btn layui-btn-small layui-btn-danger" onclick="layui.datalist.editData(${article.articleId})"><i class="layui-icon">&#xe640;</i></button>
                            </td>
                    </tr>
                </c:forEach>
    ...
    <input type="hidden" value=${pageInfo.total} id="total"/>
